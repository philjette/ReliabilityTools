              ...
              <div className="flex items-center justify-center h-full">
                <div className="text-center space-y-4 p-8 border rounded-lg bg-muted/40">
                  ...
                  <p className="text-sm text-muted-foreground max-w-md">
                    Complete the form with electrical T&D asset details to generate an AI-powered FMEA with failure mode
                    analysis, preventative maintenance recommendations, and Weibull distribution visualizations
                  </p>
                </div>
              </div>
            )}
