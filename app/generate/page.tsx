...
export default function GenerateFMEA() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight mb-2">Generate FMEA</h1>
        <p className="text-muted-foreground">
          Create a comprehensive Failure Mode and Effects Analysis for your electrical assets using AI-powered analysis.
        </p>
      </div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">{getOperatingEnvironmentLabel(formData.operatingEnvironment)}</p>
                </div>
                <div>
              ...
              <Card className="border-0">
                <AccordionTrigger className="px-6 py-4 hover:no-underline">
                  <div className="text-left">
                    ...
                    <CardDescription>
                      Detailed analysis of potential failure modes with severity, occurrence, and detection ratings
                    </CardDescription>
                  </div>
                </AccordionTrigger>
                <AccordionContent>
                  ...
                  <AccordionTrigger className="px-6 py-4 hover:no-underline">
                    <div className="flex items-center justify-between w-full pr-4">
                      <div className="text-left">
                        ...
                        <CardDescription>Reliability and failure rate curves for all failure modes</CardDescription>
                      </div>
